...
export declare namespace SustainabilityLedger {
...
export interface SustainabilityLedgerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getAllProducts"
      | "getGlobalStats"
...
export interface SustainabilityLedger extends BaseContract {
  connect(runner?: ContractRunner | null): SustainabilityLedger;
  waitForDeployment(): Promise<this>;

  interface: SustainabilityLedgerInterface;
  ...
  getAllProducts: TypedContractMethod<
    [],
    [SustainabilityLedger.ProductStructOutput[]],
    "view"
  >;
